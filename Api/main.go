...
func main() {
	...
	companyService, err := grpc.NewClient("delivery_service"+ cnf.COMPANY_PORT, grpc.WithTransportCredentials(insecure.NewCredentials()))
	if err != nil {
	...
	fmt.Println("API Gateway running on http://localhost:8081")
